...
swap address: 0x1Cd46004642868d4BDd3610Ca3Bf16DF9F0d6CE6
  */
  ...
  //await tokenA.mint(deployer, 100000);//ok
  ...
  //await tokenB.mint(deployer, 200000);//ok
